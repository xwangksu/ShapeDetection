...
# Set working path
workingPath = "H:/Dj/processed_data/India_data_2016-17/X3R_modified_MAPIR_camera/17LDH_GS_X3R_20m_RAW+JPEG_03292017/pre-processed/Calibrated/"
# Set source images path
srcImagePath = workingPath+"TIF/"
imageFiles = os.listdir(srcImagePath)
# Set GCP file
srcGCPFile = "J:/India_data_2016-17/01152017_17GS_LDH_RE_DJI_25m_80-80prc/0006SET/17LDH_GS_GCP_PS.csv"
